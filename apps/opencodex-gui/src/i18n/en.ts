...
export const en = {
  ...
  "nav.aiwrapperConnections": "Connect apps",
  "nav.aiwrapperOnboarding": "Getting started",
  "aiw.onboarding.title": "Getting started",
  "aiw.onboarding.subtitle": "A quick tour of the essentials — you can replay it any time.",
  "aiw.onboarding.progress": "Step {current} of {total}",
  "aiw.onboarding.skip": "Skip intro",
  "aiw.onboarding.back": "Back",
  "aiw.onboarding.continue": "Continue",
  "aiw.onboarding.start": "Start chatting",
  "aiw.onboarding.keyboardHint": "Use ← and → to move, Esc to finish",
  "aiw.onboarding.chatEyebrow": "Step 01 · Chat",
  "aiw.onboarding.chatTitle": "Ask once. Keep the whole conversation.",
  "aiw.onboarding.chatBody": "Choose a model and reasoning level, stream the answer, stop when needed, then copy, edit or regenerate without losing context.",
  "aiw.onboarding.conversationsEyebrow": "Step 02 · Conversations",
  "aiw.onboarding.conversationsTitle": "Come back exactly where you left off.",
  "aiw.onboarding.conversationsBody": "Search, favorite, rename, continue, export or share your saved conversations from one organized history.",
  "aiw.onboarding.usageEyebrow": "Step 03 · Usage",
  "aiw.onboarding.usageTitle": "Your quota is always visible.",
  "aiw.onboarding.usageBody": "See the five-hour and seven-day windows, model usage, token mix, cost estimate and service health before limits surprise you.",
  "aiw.onboarding.connectionsEyebrow": "Step 04 · Connect",
  "aiw.onboarding.connectionsTitle": "Use the same quota from your favorite tools.",
  "aiw.onboarding.connectionsBody": "Generate ready-to-copy Codex CLI files or OpenAI-compatible environment variables using your individual key.",
  "aiw.overview.title": "AIWrapper operations",
  "aiw.overview.subtitle": "Per-user gateway activity during the last 24 hours.",
  "aiw.overview.notConnected": "Connect with an administrator key to view operations.",
  "aiw.overview.refresh": "Refresh",
  "aiw.overview.refreshing": "Refreshing…",
  "aiw.overview.backup": "Download backup",
  "aiw.overview.backingUp": "Creating backup…",
  "aiw.overview.backupReady": "Backup created and downloaded.",
  "aiw.overview.users": "Active users",
  "aiw.overview.conversations": "Conversations",
  "aiw.overview.active": "Active requests",
  "aiw.overview.queue": "Queue",
  "aiw.overview.requests": "Requests (24h)",
  "aiw.overview.throughput": "Requests/min",
  "aiw.overview.averageLatency": "Average latency",
  "aiw.overview.p95Latency": "P95 latency",
  "aiw.overview.errors": "Errors",
  "aiw.overview.blocked": "Blocked",
  "aiw.overview.audit": "Recent security and governance events",
  "aiw.overview.event": "Event",
  "aiw.overview.target": "Target",
  "aiw.overview.when": "When",
  ...
  "aiw.tokenSaver.description": "Reduce request and response tokens with the original 9router optimization pipeline.",
  "aiw.tokenSaver.rtkDescription": "Compress large tool output before it reaches the model, typically using 60–90% fewer input tokens.",
  "aiw.tokenSaver.learnMore": "How RTK compression works",
  "aiw.tokenSaver.active": "Active",
  "aiw.tokenSaver.inactive": "Inactive",
  "aiw.tokenSaver.environmentLocked": "Disabled by the AIWRAPPER_RTK_ENABLED environment safety lock.",
  "aiw.tokenSaver.toggle": "Enable RTK token compression",
  "aiw.tokenSaver.caveman": "Caveman responses",
  "aiw.tokenSaver.cavemanDescription": "Inject a terse response style to reduce output tokens while preserving technical details.",
  "aiw.tokenSaver.ponytail": "Ponytail coding",
  "aiw.tokenSaver.ponytailDescription": "Bias coding answers toward the smallest safe implementation and shortest useful explanation.",
  "aiw.tokenSaver.level": "Compression level",
  "aiw.tokenSaver.headroom": "Enable Headroom compression",
  "aiw.tokenSaver.headroomDescription": "Send message history to a separately deployed Headroom proxy before model execution.",
  "aiw.tokenSaver.headroomUrl": "Headroom proxy URL",
  "aiw.tokenSaver.check": "Check",
  "aiw.tokenSaver.checking": "Checking",
  "aiw.tokenSaver.reachable": "Reachable",
  "aiw.tokenSaver.unreachable": "Unreachable",
  "aiw.tokenSaver.compressUserMessages": "Allow Headroom to compress user messages",
  "aiw.notifications.open": "Open notifications",
  "aiw.notifications.title": "Notifications",
  "aiw.notifications.subtitle": "Quota, security, and account activity.",
  "aiw.notifications.markAllRead": "Mark all read",
  "aiw.notifications.markRead": "Mark as read",
  "aiw.notifications.clear": "Clear notification",
  "aiw.notifications.resolve": "Resolve",
  "aiw.notifications.attention": "Attention",
  "aiw.notifications.today": "Today",
  ...
  "aiw.notifications.filter": "Filter notifications",
  "aiw.notifications.unreadOnly": "Unread only",
  "aiw.notifications.categories": "Categories",
  "aiw.notifications.category.task": "Task activity",
  "aiw.notifications.category.collaboration": "Collaboration",
  "aiw.notifications.category.system": "System issues",
  "aiw.notifications.filterEmpty": "No activity matches this filter.",
  "aiw.notifications.resetFilters": "Reset filters",
  "aiw.connections.title": "Connect apps",
  "aiw.connections.subtitle": "Use your individual quota safely from Codex CLI and OpenAI-compatible tools.",
  "aiw.connections.codexTitle": "Codex CLI",
  "aiw.connections.codexDescription": "Generate the two local files that route Codex through AIWrapper.",
  "aiw.connections.endpoint": "AIWrapper endpoint",
  "aiw.connections.loopbackHint": "This local address works only on the server computer. Remote users need the HTTPS or private-network address.",
  "aiw.connections.individualKey": "Your individual key",
  "aiw.connections.model": "Default model",
  "aiw.connections.loadingModels": "Loading models…",
  "aiw.connections.modelsUnavailable": "Live model discovery is unavailable. Enter a model ID manually.",
  "aiw.connections.subagentModel": "Subagent model",
  "aiw.connections.sameAsDefault": "Same as default model",
  "aiw.connections.subagentHint": "Leave blank to use the default model.",
  "aiw.connections.memoryOnly": "Your key stays only in this page's memory. It is never sent to storage or written on the server.",
  "aiw.connections.filesTitle": "Manual configuration",
  "aiw.connections.filesDescription": "Save these files on the computer where Codex CLI will run.",
  "aiw.connections.showSecret": "Show secret",
  "aiw.connections.hideSecret": "Hide secret",
  "aiw.connections.copy": "Copy",
  "aiw.connections.copied": "Copied",
  "aiw.connections.copyUnavailable": "Copy unavailable",
  "aiw.connections.environmentTitle": "Other OpenAI-compatible apps",
  "aiw.connections.environmentDescription": "Use these environment variables in clients that accept an OpenAI base URL.",
  "aiw.connections.copyEnvironment": "Copy variables",
  ...
  "aiw.connect.restoring": "Restoring your secure session…",
  ...
  "aiw.chat.sort": "Sort conversations",
  "aiw.chat.sortRecent": "Most recent",
  "aiw.chat.sortOldest": "Oldest",
  "aiw.chat.sortTitleAsc": "Title A–Z",
  "aiw.chat.sortTitleDesc": "Title Z–A",
  ...
  "aiw.sharing.session": "Conversation",
  "aiw.sharing.expiration": "Expiration",
  "aiw.sharing.oneDay": "1 day",
  "aiw.sharing.sevenDays": "7 days",
  "aiw.sharing.thirtyDays": "30 days",
  "aiw.sharing.noExpiration": "No expiration",
  "aiw.sharing.createdReady": "Link created and copied. It is shown only now.",
  "aiw.sharing.hiddenLink": "Secret link hidden; create another if it was lost.",
  "aiw.sharing.linkUnavailable": "The server did not return the one-time secret link.",
  "aiw.sharing.actions": "Actions",
  "aiw.sharing.revoke": "Revoke link",
  "aiw.sharing.revokeConfirm": "Revoke this shared link now?",
  "aiw.shared.title": "Shared conversation",
  "aiw.shared.loading": "Loading shared conversation…",
  "aiw.shared.unavailable": "This shared conversation expired, was revoked, or does not exist.",
  "aiw.shared.readOnly": "Read-only shared conversation",
  "aiw.shared.empty": "This conversation has no messages.",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "nav.searchPlaceholder": "Find a page…",
  "nav.searchEmpty": "No pages found",
