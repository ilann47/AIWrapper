...
export const zh: Record<TKey, string> = {
  ...
  "nav.aiwrapperConnections": "连接应用",
  "nav.aiwrapperOnboarding": "开始使用",
  "aiw.onboarding.title": "开始使用",
  "aiw.onboarding.subtitle": "快速了解核心功能，之后可随时重播。",
  "aiw.onboarding.progress": "第 {current} 步，共 {total} 步",
  "aiw.onboarding.skip": "跳过介绍",
  "aiw.onboarding.back": "返回",
  "aiw.onboarding.continue": "继续",
  "aiw.onboarding.start": "开始聊天",
  "aiw.onboarding.keyboardHint": "使用 ← 和 → 移动，按 Esc 完成",
  "aiw.onboarding.chatEyebrow": "步骤 01 · 聊天",
  "aiw.onboarding.chatTitle": "问一次，保留完整对话。",
  "aiw.onboarding.chatBody": "选择模型和推理级别，流式接收回答，并在不丢失上下文的情况下复制、编辑或重新生成。",
  "aiw.onboarding.conversationsEyebrow": "步骤 02 · 对话",
  "aiw.onboarding.conversationsTitle": "从上次离开的地方继续。",
  "aiw.onboarding.conversationsBody": "在统一历史中搜索、收藏、重命名、继续、导出或分享保存的对话。",
  "aiw.onboarding.usageEyebrow": "步骤 03 · 用量",
  "aiw.onboarding.usageTitle": "配额始终清晰可见。",
  "aiw.onboarding.usageBody": "查看 5 小时和 7 天窗口、模型用量、令牌、成本估算及服务健康状态。",
  "aiw.onboarding.connectionsEyebrow": "步骤 04 · 连接",
  "aiw.onboarding.connectionsTitle": "在常用工具中使用同一配额。",
  "aiw.onboarding.connectionsBody": "使用个人密钥生成 Codex CLI 文件或 OpenAI 兼容环境变量。",
  "aiw.overview.title": "AIWrapper 运行状况",
  "aiw.overview.subtitle": "过去 24 小时的用户网关活动。",
  "aiw.overview.notConnected": "请使用管理员密钥连接以查看运行状况。",
  "aiw.overview.refresh": "刷新",
  "aiw.overview.refreshing": "刷新中…",
  "aiw.overview.backup": "下载备份",
  "aiw.overview.backingUp": "正在创建备份…",
  "aiw.overview.backupReady": "备份已创建并下载。",
  "aiw.overview.users": "活跃用户",
  "aiw.overview.conversations": "对话",
  "aiw.overview.active": "活动请求",
  "aiw.overview.queue": "队列",
  "aiw.overview.requests": "请求（24 小时）",
  "aiw.overview.throughput": "请求/分钟",
  "aiw.overview.averageLatency": "平均延迟",
  "aiw.overview.p95Latency": "P95 延迟",
  "aiw.overview.errors": "错误",
  "aiw.overview.blocked": "已阻止",
  "aiw.overview.audit": "最近的安全与治理事件",
  "aiw.overview.event": "事件",
  "aiw.overview.target": "目标",
  "aiw.overview.when": "时间",
  ...
  "aiw.tokenSaver.title": "令牌节省",
  "aiw.tokenSaver.description": "使用原始 9router 优化管线减少请求和响应令牌。",
  "aiw.tokenSaver.rtkDescription": "在发送到模型前压缩大型工具输出，通常可减少60–90%的输入令牌。",
  "aiw.tokenSaver.learnMore": "RTK 压缩如何工作",
  "aiw.tokenSaver.active": "已启用",
  "aiw.tokenSaver.inactive": "未启用",
  "aiw.tokenSaver.environmentLocked": "已被 AIWRAPPER_RTK_ENABLED 环境安全锁禁用。",
  "aiw.tokenSaver.toggle": "启用 RTK 令牌压缩",
  "aiw.tokenSaver.caveman": "精简回复",
  "aiw.tokenSaver.cavemanDescription": "注入精简回复风格，同时保留技术细节。",
  "aiw.tokenSaver.ponytail": "最小代码",
  "aiw.tokenSaver.ponytailDescription": "优先采用最小安全实现和最短有效说明。",
  "aiw.tokenSaver.level": "压缩级别",
  "aiw.tokenSaver.headroom": "启用 Headroom 压缩",
  "aiw.tokenSaver.headroomDescription": "在模型执行前将消息历史发送到单独部署的 Headroom 代理。",
  "aiw.tokenSaver.headroomUrl": "Headroom 代理 URL",
  "aiw.tokenSaver.check": "检查",
  "aiw.tokenSaver.checking": "检查中",
  "aiw.tokenSaver.reachable": "可连接",
  "aiw.tokenSaver.unreachable": "不可连接",
  "aiw.tokenSaver.compressUserMessages": "允许 Headroom 压缩用户消息",
  "aiw.notifications.open": "打开通知",
  "aiw.notifications.title": "通知",
  "aiw.notifications.subtitle": "配额、安全和账户活动。",
  "aiw.notifications.markAllRead": "全部标为已读",
  "aiw.notifications.markRead": "标为已读",
  "aiw.notifications.clear": "清除通知",
  "aiw.notifications.resolve": "解决",
  "aiw.notifications.attention": "需要注意",
  "aiw.notifications.today": "今天",
  ...
  "aiw.notifications.filter": "筛选通知",
  "aiw.notifications.unreadOnly": "仅未读",
  "aiw.notifications.categories": "类别",
  "aiw.notifications.category.task": "任务活动",
  "aiw.notifications.category.collaboration": "协作",
  "aiw.notifications.category.system": "系统问题",
  "aiw.notifications.filterEmpty": "没有符合此筛选条件的活动。",
  "aiw.notifications.resetFilters": "重置筛选",
  "aiw.connections.title": "连接应用",
  "aiw.connections.subtitle": "从 Codex CLI 和 OpenAI 兼容工具安全使用个人配额。",
  "aiw.connections.codexTitle": "Codex CLI",
  "aiw.connections.codexDescription": "生成将 Codex 接入 AIWrapper 的本地配置文件。",
  "aiw.connections.endpoint": "AIWrapper 端点",
  "aiw.connections.loopbackHint": "此本地地址仅在服务器计算机上可用。远程用户需要 HTTPS 或专用网络地址。",
  "aiw.connections.individualKey": "个人密钥",
  "aiw.connections.model": "默认模型",
  "aiw.connections.loadingModels": "正在加载模型…",
  "aiw.connections.modelsUnavailable": "无法获取模型列表。请手动输入模型 ID。",
  "aiw.connections.subagentModel": "子代理模型",
  "aiw.connections.sameAsDefault": "与默认模型相同",
  "aiw.connections.subagentHint": "留空以使用默认模型。",
  "aiw.connections.memoryOnly": "密钥仅保留在本页内存中，不会存储或写入服务器。",
  "aiw.connections.filesTitle": "手动配置",
  "aiw.connections.filesDescription": "将这些文件保存到运行 Codex CLI 的计算机上。",
  "aiw.connections.showSecret": "显示密钥",
  "aiw.connections.hideSecret": "隐藏密钥",
  "aiw.connections.copy": "复制",
  "aiw.connections.copied": "已复制",
  "aiw.connections.copyUnavailable": "无法复制",
  "aiw.connections.environmentTitle": "其他 OpenAI 兼容应用",
  "aiw.connections.environmentDescription": "在支持 OpenAI 基础 URL 的客户端中使用这些环境变量。",
  "aiw.connections.copyEnvironment": "复制变量",
  ...
  "aiw.connect.restoring": "正在恢复安全会话…",
  ...
  "aiw.chat.sort": "对话排序",
  "aiw.chat.sortRecent": "最近更新",
  "aiw.chat.sortOldest": "最早更新",
  "aiw.chat.sortTitleAsc": "标题 A–Z",
  "aiw.chat.sortTitleDesc": "标题 Z–A",
  ...
  "aiw.sharing.session": "对话",
  "aiw.sharing.expiration": "到期时间",
  "aiw.sharing.oneDay": "1 天",
  "aiw.sharing.sevenDays": "7 天",
  "aiw.sharing.thirtyDays": "30 天",
  "aiw.sharing.noExpiration": "永不过期",
  "aiw.sharing.createdReady": "链接已创建并复制，仅在此时显示。",
  "aiw.sharing.hiddenLink": "秘密链接已隐藏；如果丢失，请重新创建。",
  "aiw.sharing.linkUnavailable": "服务器未返回一次性秘密链接。",
  "aiw.sharing.actions": "操作",
  "aiw.sharing.revoke": "撤销链接",
  "aiw.sharing.revokeConfirm": "立即撤销此共享链接？",
  "aiw.shared.title": "共享对话",
  "aiw.shared.loading": "正在加载共享对话…",
  "aiw.shared.unavailable": "此共享已过期、被撤销或不存在。",
  "aiw.shared.readOnly": "只读共享对话",
  "aiw.shared.empty": "此对话没有消息。",
  ...
  "nav.openMenu": "打开菜单",
  "nav.searchPlaceholder": "查找页面…",
  "nav.searchEmpty": "未找到页面",
