...
export const ko: Record<TKey, string> = {
  ...
  "nav.aiwrapperConnections": "앱 연결",
  "nav.aiwrapperOnboarding": "시작하기",
  "aiw.onboarding.title": "시작하기",
  "aiw.onboarding.subtitle": "핵심 기능을 빠르게 살펴보세요. 언제든 다시 볼 수 있습니다.",
  "aiw.onboarding.progress": "{total}단계 중 {current}",
  "aiw.onboarding.skip": "소개 건너뛰기",
  "aiw.onboarding.back": "뒤로",
  "aiw.onboarding.continue": "계속",
  "aiw.onboarding.start": "채팅 시작",
  "aiw.onboarding.keyboardHint": "←, →로 이동하고 Esc로 종료",
  "aiw.onboarding.chatEyebrow": "1단계 · 채팅",
  "aiw.onboarding.chatTitle": "한 번 질문하고 전체 대화를 보관하세요.",
  "aiw.onboarding.chatBody": "모델과 추론 수준을 선택하고 답변을 스트리밍한 뒤 문맥을 잃지 않고 복사, 편집, 재생성하세요.",
  "aiw.onboarding.conversationsEyebrow": "2단계 · 대화",
  "aiw.onboarding.conversationsTitle": "중단한 곳에서 정확히 이어가세요.",
  "aiw.onboarding.conversationsBody": "저장된 대화를 검색, 즐겨찾기, 이름 변경, 계속, 내보내기 또는 공유할 수 있습니다.",
  "aiw.onboarding.usageEyebrow": "3단계 · 사용량",
  "aiw.onboarding.usageTitle": "할당량을 언제나 확인하세요.",
  "aiw.onboarding.usageBody": "5시간·7일 기간, 모델 사용량, 토큰, 예상 비용과 서비스 상태를 확인하세요.",
  "aiw.onboarding.connectionsEyebrow": "4단계 · 연결",
  "aiw.onboarding.connectionsTitle": "즐겨 쓰는 도구에서도 같은 할당량을 사용하세요.",
  "aiw.onboarding.connectionsBody": "개별 키로 Codex CLI 파일이나 OpenAI 호환 환경 변수를 생성하세요.",
  "aiw.overview.title": "AIWrapper 운영",
  "aiw.overview.subtitle": "최근 24시간의 사용자별 게이트웨이 활동입니다.",
  "aiw.overview.notConnected": "운영 정보를 보려면 관리자 키로 연결하세요.",
  "aiw.overview.refresh": "새로 고침",
  "aiw.overview.refreshing": "새로 고치는 중…",
  "aiw.overview.backup": "백업 다운로드",
  "aiw.overview.backingUp": "백업 생성 중…",
  "aiw.overview.backupReady": "백업을 생성하고 다운로드했습니다.",
  "aiw.overview.users": "활성 사용자",
  "aiw.overview.conversations": "대화",
  "aiw.overview.active": "활성 요청",
  "aiw.overview.queue": "대기열",
  "aiw.overview.requests": "요청(24시간)",
  "aiw.overview.throughput": "분당 요청",
  "aiw.overview.averageLatency": "평균 지연 시간",
  "aiw.overview.p95Latency": "P95 지연 시간",
  "aiw.overview.errors": "오류",
  "aiw.overview.blocked": "차단됨",
  "aiw.overview.audit": "최근 보안 및 거버넌스 이벤트",
  "aiw.overview.event": "이벤트",
  "aiw.overview.target": "대상",
  "aiw.overview.when": "시간",
  ...
  "aiw.tokenSaver.title": "토큰 절약",
  "aiw.tokenSaver.description": "9router 원본 최적화 파이프라인으로 요청 및 응답 토큰을 줄입니다.",
  "aiw.tokenSaver.rtkDescription": "큰 도구 출력을 모델로 보내기 전에 압축하여 일반적으로 입력 토큰을 60~90% 줄입니다.",
  "aiw.tokenSaver.learnMore": "RTK 압축 작동 방식",
  "aiw.tokenSaver.active": "활성",
  "aiw.tokenSaver.inactive": "비활성",
  "aiw.tokenSaver.environmentLocked": "AIWRAPPER_RTK_ENABLED 환경 안전 잠금으로 비활성화되었습니다.",
  "aiw.tokenSaver.toggle": "RTK 토큰 압축 활성화",
  "aiw.tokenSaver.caveman": "간결한 응답",
  "aiw.tokenSaver.cavemanDescription": "기술적 세부 정보를 유지하면서 간결한 응답 스타일을 추가합니다.",
  "aiw.tokenSaver.ponytail": "최소 코드",
  "aiw.tokenSaver.ponytailDescription": "가장 작고 안전한 구현과 짧은 설명을 우선합니다.",
  "aiw.tokenSaver.level": "압축 수준",
  "aiw.tokenSaver.headroom": "Headroom 압축 활성화",
  "aiw.tokenSaver.headroomDescription": "모델 실행 전에 메시지 기록을 별도로 배포된 Headroom 프록시로 보냅니다.",
  "aiw.tokenSaver.headroomUrl": "Headroom 프록시 URL",
  "aiw.tokenSaver.check": "확인",
  "aiw.tokenSaver.checking": "확인 중",
  "aiw.tokenSaver.reachable": "연결 가능",
  "aiw.tokenSaver.unreachable": "연결 불가",
  "aiw.tokenSaver.compressUserMessages": "사용자 메시지 압축 허용",
  "aiw.notifications.open": "알림 열기",
  "aiw.notifications.title": "알림",
  "aiw.notifications.subtitle": "할당량, 보안 및 계정 활동입니다.",
  "aiw.notifications.markAllRead": "모두 읽음",
  "aiw.notifications.markRead": "읽음으로 표시",
  "aiw.notifications.clear": "알림 지우기",
  "aiw.notifications.resolve": "해결",
  "aiw.notifications.attention": "주의 필요",
  "aiw.notifications.today": "오늘",
  ...
  "aiw.notifications.filter": "알림 필터",
  "aiw.notifications.unreadOnly": "읽지 않음만",
  "aiw.notifications.categories": "카테고리",
  "aiw.notifications.category.task": "작업 활동",
  "aiw.notifications.category.collaboration": "협업",
  "aiw.notifications.category.system": "시스템 문제",
  "aiw.notifications.filterEmpty": "이 필터와 일치하는 활동이 없습니다.",
  "aiw.notifications.resetFilters": "필터 재설정",
  "aiw.connections.title": "앱 연결",
  "aiw.connections.subtitle": "Codex CLI와 OpenAI 호환 도구에서 개인 할당량을 안전하게 사용합니다.",
  "aiw.connections.codexTitle": "Codex CLI",
  "aiw.connections.codexDescription": "Codex를 AIWrapper로 연결하는 로컬 설정 파일을 생성합니다.",
  "aiw.connections.endpoint": "AIWrapper 엔드포인트",
  "aiw.connections.loopbackHint": "이 로컬 주소는 서버 컴퓨터에서만 작동합니다. 원격 사용자는 HTTPS 또는 사설 네트워크 주소가 필요합니다.",
  "aiw.connections.individualKey": "개인 키",
  "aiw.connections.model": "기본 모델",
  "aiw.connections.loadingModels": "모델 불러오는 중…",
  "aiw.connections.modelsUnavailable": "모델 목록을 가져올 수 없습니다. 모델 ID를 직접 입력하세요.",
  "aiw.connections.subagentModel": "하위 에이전트 모델",
  "aiw.connections.sameAsDefault": "기본 모델과 동일",
  "aiw.connections.subagentHint": "기본 모델을 사용하려면 비워 두세요.",
  "aiw.connections.memoryOnly": "키는 이 페이지의 메모리에만 유지되며 저장되거나 서버에 기록되지 않습니다.",
  "aiw.connections.filesTitle": "수동 구성",
  "aiw.connections.filesDescription": "Codex CLI를 실행할 컴퓨터에 이 파일들을 저장하세요.",
  "aiw.connections.showSecret": "키 표시",
  "aiw.connections.hideSecret": "키 숨기기",
  "aiw.connections.copy": "복사",
  "aiw.connections.copied": "복사됨",
  "aiw.connections.copyUnavailable": "복사 불가",
  "aiw.connections.environmentTitle": "기타 OpenAI 호환 앱",
  "aiw.connections.environmentDescription": "OpenAI 기본 URL을 지원하는 클라이언트에서 이 환경 변수를 사용하세요.",
  "aiw.connections.copyEnvironment": "변수 복사",
  ...
  "aiw.connect.restoring": "보안 세션을 복원하는 중…",
  ...
  "aiw.chat.sort": "대화 정렬",
  "aiw.chat.sortRecent": "최신순",
  "aiw.chat.sortOldest": "오래된순",
  "aiw.chat.sortTitleAsc": "제목 A–Z",
  "aiw.chat.sortTitleDesc": "제목 Z–A",
  ...
  "aiw.sharing.session": "대화",
  "aiw.sharing.expiration": "만료",
  "aiw.sharing.oneDay": "1일",
  "aiw.sharing.sevenDays": "7일",
  "aiw.sharing.thirtyDays": "30일",
  "aiw.sharing.noExpiration": "만료 없음",
  "aiw.sharing.createdReady": "링크가 생성되고 복사되었습니다. 지금만 표시됩니다.",
  "aiw.sharing.hiddenLink": "비밀 링크가 숨겨졌습니다. 분실했다면 새로 만드세요.",
  "aiw.sharing.linkUnavailable": "서버가 일회용 비밀 링크를 반환하지 않았습니다.",
  "aiw.sharing.actions": "작업",
  "aiw.sharing.revoke": "링크 취소",
  "aiw.sharing.revokeConfirm": "이 공유 링크를 지금 취소할까요?",
  "aiw.shared.title": "공유된 대화",
  "aiw.shared.loading": "공유된 대화를 불러오는 중…",
  "aiw.shared.unavailable": "이 공유는 만료되었거나 취소되었거나 존재하지 않습니다.",
  "aiw.shared.readOnly": "읽기 전용 공유 대화",
  "aiw.shared.empty": "이 대화에는 메시지가 없습니다.",
  ...
  "nav.openMenu": "메뉴 열기",
  "nav.searchPlaceholder": "페이지 찾기…",
  "nav.searchEmpty": "페이지를 찾을 수 없습니다",
  "nav.clearSearch": "검색 지우기",
  "nav.closeMenu": "메뉴 닫기",
