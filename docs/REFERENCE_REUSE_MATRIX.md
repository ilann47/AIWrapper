...
The authoritative matrix is [UPSTREAM_ADOPTION.md](./UPSTREAM_ADOPTION.md). Exact per-file metrics are generated in [generated/UPSTREAM_DIFF_REPORT.md](./generated/UPSTREAM_DIFF_REPORT.md).
