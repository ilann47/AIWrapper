...
export const ANTIGRAVITY_OAUTH_CLIENT = {
  clientId: process.env.NINE_ROUTER_ANTIGRAVITY_OAUTH_CLIENT_ID || "",
  clientSecret: process.env.NINE_ROUTER_ANTIGRAVITY_OAUTH_CLIENT_SECRET || ""
};
...
export const GOOGLE_OAUTH_CLIENT = {
  clientId: process.env.NINE_ROUTER_GOOGLE_OAUTH_CLIENT_ID || "",
  clientSecret: process.env.NINE_ROUTER_GOOGLE_OAUTH_CLIENT_SECRET || ""
};
